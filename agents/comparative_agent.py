...
from prompts import comparative_analysis_agent
...
def _modify_state_messages(state: AgentState):
    ...
    return comparative_analysis_agent.invoke({"messages": messages}).to_messages()

tools = [fetch_relevant_response]

async def comparative_agents_stream(query: str, user_id: str, thread_id: str, query_id: str, file_id_list : list,timeout_: int = 55):
    try:
