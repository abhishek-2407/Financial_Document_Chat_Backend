...
def _modify_state_messages(state: AgentState):
    ...
    return expense_analyst_agent.invoke({"messages": messages}).to_messages()

tools = [fetch_relevant_response]

async def expense_agents_stream(query: str, user_id: str, thread_id: str, query_id: str, file_id_list : list,timeout_: int = 55):
    try:
