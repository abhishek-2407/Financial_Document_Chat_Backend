...
from prompts import core_statement_agent_prompt,common_prompt_func
...
def _modify_state_messages(state: AgentState):
    ...
    return core_statement_agent_prompt.invoke({"messages": messages})

tools = [fetch_relevant_response, fetch_standalone_data, fetch_consolidated_data]

async def core_statement_agents_stream(query: str, user_id: str, query_id: str, file_id_list : list, notes : str,timeout_: int = 55):
    try:
        ...
        async with AsyncConnectionPool(
            ...
            langgraph_agent_executor = create_react_agent(
                                                        model, 
                                                        tools,
                                                        prompt=core_statement_agent_prompt
