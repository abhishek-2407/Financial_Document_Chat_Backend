...
import asyncio
from functions.append_tables_to_sql_db import process_consolidated_data, process_standalone_data
import logging
...
# async def main():
response = process_standalone_data(
    query="Balance sheet",
    file_id_list=["30059241-8e23-47cf-a911-c8cf2fbec4d0"],
    company_name="Hindalco 2025"
)
print(response)
